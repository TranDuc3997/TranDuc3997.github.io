...
function checkPass(){
  ...
  var check_pass = document.getElementById("check__pass");
...
function checkUser(){
  ...
  var check_user = document.getElementById("check__user");
...
function checkEmail() {
  ...
  var check_email = document.getElementById("check__email");
